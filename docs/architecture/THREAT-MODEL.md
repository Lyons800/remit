...
| T36 | A structural World fact or checksum is mistaken for authenticated authority | Whole-bundle admission through an authenticated atomic repository writer         | Loose, serialized, truncated, or unauthenticated facts fail    |
