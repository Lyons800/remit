...
| -------------------- | -------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------- |
| Collection created   | `0.0.9757606`, `Remit Payables - NO VALUE`, `IGPAY`, non-fungible                                              | [transaction](https://hashscan.io/testnet/transaction/0.0.9708355-1785024779-350224287)     |
...
- used Remit's canonical payment-action digest, which is an unprefixed lowercase
