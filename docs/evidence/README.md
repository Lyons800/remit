...
| [HTS lifecycle marker](hts-payable-live-2026-07-26.md)               | committed create, sealed configuration, mint, exact metadata, burn, and zero supply                           | Audited live demo; deliberately excluded from payment authority and replay prevention          |
| [Dual-token atomic settlement](hedera-dual-token-live-2026-07-26.md) | signed-wire-admitted 48,000-atom payment, dual NFT return/burn, atomic HCS commitment, and consensus rollback | Experimental Testnet mechanics fixture; production NO-GO and not fresh World/x402 authority    |
